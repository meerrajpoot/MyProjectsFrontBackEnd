          ...
          {books.map((book) => (
            <li key={book.id} className="border-b p-2 flex justify-between items-center">
              <div>
                ...
                <p className="text-sm  text-gray-600"><span className='font-extrabold'>Author:</span> {book.author}</p>
                <p className="text-sm text-gray-700"><span className='font-extrabold'>Description:</span>{book.description}</p>
              </div>
              <div>
